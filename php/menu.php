...
echo
        ...
        '<form action="menu.php" method="GET" style="text-align: center;"><a href="menu.php?jour=11&mois=10&annee=2022" style="float: left;">Jour précédent</a><a href="menu.php?jour=13&mois=10&annee=2022" style="float: right;">Jour suivant</a>Date : <select name="jour">',
            ...
            '</select><input type="submit" value="Consulter" style="padding: 2px;"></form>',
        '<section>',
            '<h3>Entrées</h3>',
            '<div class="flexdiv">',
