...
function AffContenuPageINDEX(): void{
    ...
    '<p>Finies les interminables files d\'attente qui s\'étiraient jusqu\'à l\'extérieur des bâtiments. </p>',
        ...
        '<div class="liens"><a href="#fonctionnement">Le fonctionnement de eResto-U</a><a href="#avantages">Les avantages de eResto-U</a><a href="#partenariat">Un partenariat 100% Franc-Comtois</a></div>',
        ...
        '<section id="partenariat">',
            ...
            '<h4>Un puissant outil d\'aide à la décision</h4><img style="float: left; height: 80px; width: auto; margin-top: 20px; margin-right: 10px;" src="images/eco-friendly.png" alt="Logo eco-friendly">',
